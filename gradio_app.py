...
from OFA.fairseq import checkpoint_utils
from OFA.fairseq import options, tasks, utils
from OFA.fairseq.dataclass.utils import convert_namespace_to_omegaconf
...
if __name__ == "__main__":
    ...
    description = (
        ...
        "Y ou can use different instructions to perform various tasks (i.e., image captioning, visual grounding,"
