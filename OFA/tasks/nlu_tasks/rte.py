...
from data.nlu_data.rte_dataset import RTEDataset
...
@register_task("rte", dataclass=RTEConfig)
class RTETask(OFATask):
    def __init__(self, cfg: RTEConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = RTEDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
