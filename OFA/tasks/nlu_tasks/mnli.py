...
@dataclass
class MNLIConfig(OFAConfig):
    ans2label_dict: Optional[str] = field(
        default='{"maybe": 0, "yes": 1, "no": 2}',
...
@register_task("mnli", dataclass=MNLIConfig)
class MNLITask(OFATask):
    def __init__(self, cfg: MNLIConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = MNLIDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
