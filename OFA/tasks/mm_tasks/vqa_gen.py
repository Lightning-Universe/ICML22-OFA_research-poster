    ...
    def valid_step(self, sample, model, criterion, **extra_kwargs):
        ...
        with torch.no_grad():
            if self.cfg.val_inference_type == "allcand":
                ...
                valid_result = []
                for valid_answers, valid_constraint_masks in zip(self.valid_answers_list,
                        self.valid_constraint_masks_list):
                    ...
                    valid_constraint_mask_items = [
                        ...
                        for decoder_prompt in sample["decoder_prompts"] for valid_constraint_mask in
                    ...
                    valid_prev_output = data_utils.collate_tokens(valid_prev_items, pad_idx=pad, left_pad=False).to(
                        device)
                    valid_constraint_masks = data_utils.collate_tokens(valid_constraint_mask_items, pad_idx=pad,
